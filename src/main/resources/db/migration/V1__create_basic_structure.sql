...
insert into usr (email, nickname, password, activated, creation_date) values ('default@rika0525.com', 'Default', '$2a$10$juJwntMUSXoYFocl1nBI9Oye3OhjgQlWlHApEnkP4TQms.wIQaIHG', true, CURRENT_TIMESTAMP);
